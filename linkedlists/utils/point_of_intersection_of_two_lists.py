...
def run():
    ...
    common_node_1 = SinglyLinkedList.get_new_node(60)
    common_node_1.next = SinglyLinkedList.get_new_node(70)
    common_node_1.next.next = SinglyLinkedList.get_new_node(80)
    new_common_tail = SinglyLinkedList.get_new_node(90)
